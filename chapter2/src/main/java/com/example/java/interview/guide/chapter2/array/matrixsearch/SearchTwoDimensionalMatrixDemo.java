...
public class SearchTwoDimensionalMatrixDemo {
    public static void main(String[] args) {
        ...
        System.out.println(searchTwoDimensionalMatrix.contains(matrix, 5));
        System.out.print("二维矩阵是否含有20：");
        System.out.println(searchTwoDimensionalMatrix.contains(matrix, 20));
        System.out.print("二维矩阵是否含有8：");
        System.out.println(searchTwoDimensionalMatrix.search(matrix, 8));
        System.out.print("二维矩阵是否含有28：");
        System.out.println(searchTwoDimensionalMatrix.search(matrix, 28));
    }
}
